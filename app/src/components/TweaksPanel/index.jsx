...
export function TweaksPanel({ title = 'Tweaks', children }) {
  ...
  return (
    <div ref={dragRef} className={styles.panel}
      ...
      <div className={styles.hd} onMouseDown={onDragStart}>
        <b>{title}</b>
        <button className={styles.x} aria-label="Close tweaks"
...
export function TweakRow({ label, value, children, inline = false }) {
  return (
    <div className={inline ? `${styles.row} ${styles.rowH}` : styles.row}>
      <div className={styles.lbl}>
        <span>{label}</span>
        {value != null && <span className={styles.val}>{value}</span>}
      </div>
      {children}
    </div>
  );
...
export function TweakToggle({ label, value, onChange }) {
  return (
    <div className={`${styles.row} ${styles.rowH}`}>
      <div className={styles.lbl}><span>{label}</span></div>
  ...
  return (
    <TweakRow label={label}>
      <div ref={trackRef} role="radiogroup" onPointerDown={onPointerDown}
           className={dragging ? `${styles.seg} ${styles.dragging}` : styles.seg}>
